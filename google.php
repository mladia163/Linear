...
?>
 ...
 $com="UPDATE comp set cid=1 where chk=0";
 mysql_query($com,$con_hack);
 
 $lqr="SELECT * from luxury where cid=1";
 $lq=mysql_query($lqr,$con_hack);
 $lux=mysql_fetch_assoc($lq);
 
 $fqr="SELECT * from food where cid=1";
 $fq=mysql_query($fqr,$con_hack);
 $food=mysql_fetch_assoc($fq);
 
 $tqr="SELECT * from travel where cid=1";
